...
\begin{frame}{Альтернативная постановка задачи обнаружения связи}
	...
	$
	\mathbb{T}_{\mathcal{X}}(y|x) : \mathcal{X} \to \mathbb{P}(\mathcal{Y})
	$
...
\begin{frame}{Выносится на защиту}
	\begin{enumerate}
		\item Проведено сравнение метод выявления причинно-следственных связей
		
		\item Предложен новый способ обнаружения связей, учитывающий высокую размерность данных
